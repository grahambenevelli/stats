	...
	private Map<Position, StdDevStats> consumeStdDevByPosition(ResultSet result) throws SQLException {
		...
		while(result.next()) {
			...
			StdDevStats stdDevStats = StdDevStats.builder()
					...
					.passingCompletions(result.getDouble("passing_completions"))
					.passingYards(result.getDouble("passing_yards"))
					.passingTouchdowns(result.getDouble("passing_touchdowns"))
					.interceptions(result.getDouble("interceptions"))
					.rushingAttempts(result.getDouble("rushing_attempts"))
					.rushingYards(result.getDouble("rushing_yards"))
					.rushingTouchdowns(result.getDouble("rushing_touchdowns"))
					.rushingLong(result.getDouble("rushing_long"))
					.rushingLongTouchdown(result.getDouble("rushing_long_touchdown"))
					.receptions(result.getDouble("receptions"))
					.receivingYards(result.getDouble("receiving_yards"))
					.receivingTouchdowns(result.getDouble("receiving_touchdowns"))
					.receivingLong(result.getDouble("receiving_long"))
					.receivingLongTouchdown(result.getDouble("receiving_long_touchdown"))
					.fumbles(result.getDouble("fumbles"))
					.fumblesLost(result.getDouble("fumbles_lost"))
					.fumblesRecovered(result.getDouble("fumbles_recovered"))
					.fumbleYards(result.getDouble("fumble_yards"))
					.build();
