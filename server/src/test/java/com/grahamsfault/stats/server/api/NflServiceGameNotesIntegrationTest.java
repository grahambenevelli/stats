...
import com.grahamsfault.stats.server.api.model.game.drive.Drive;
import com.grahamsfault.stats.server.api.model.game.drive.GameDrives;
import com.grahamsfault.stats.server.api.model.game.drive.play.PlayEntry;
import com.grahamsfault.stats.server.api.model.game.drive.play.PlayPlayerStatEntry;
import com.grahamsfault.stats.server.api.model.game.drive.play.PlayPlayersWrapper;
import com.grahamsfault.stats.server.api.model.game.team.GameTeamNotes;
import com.grahamsfault.stats.server.api.model.game.team.QuarterlyScores;
import com.grahamsfault.stats.server.api.model.player.PlayerStatsSet;
...
public class NflServiceGameNotesIntegrationTest {
	...
	public void testGetGameStatsBasicGameNotes() throws NflServiceException {
		...
		Assert.assertEquals(gameNotes.getPosteam(), Team.DENVER);
	...
	public void testGetGameStatsFirstDriveBasic() {
		...
		Assert.assertEquals(actual.getPosteam(), Team.BALTIMORE);
	...
	public void testGetGameStatsFirstDrivesFirstPlayBasic() {
		...
		Assert.assertEquals(actual.getPosteam(), Team.DENVER);
